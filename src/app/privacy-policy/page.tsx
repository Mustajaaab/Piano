...
export default function Home() {
  return (
    <main className="container mx-auto">
        ...
        <p className="text-[#454545] text-lg font-normal mt-7 leading-9">The only data we access (microphone input) is used in real-time and only for the purpose of providing tuning functionality. We do not store, share, or analyze this data beyond its immediate use.</p>

        <h2 className="text-[#494949] text-3xl font-semibold mt-8">3. Third-Party Services</h2>
        <p className="text-[#454545] text-lg font-normal mt-7 leading-9">We do not use any third-party services, plugins, or analytics tools. Your interaction with our tool remains entirely private and secure.</p>
        ...
        <p className="text-[#454545] text-lg font-normal mt-7 leading-9">While we do not store personal data, we are committed to ensuring that the tool functions securely and respects your privacy at all times.</p>

        <h2 className="text-[#494949] text-3xl font-semibold mt-8">7. Changes to This Privacy Policy</h2>
        <p className="text-[#454545] text-lg font-normal mt-7 leading-9">We may update this Privacy Policy from time to time. Any changes will be reflected on this page with an updated "Effective Date."</p>
